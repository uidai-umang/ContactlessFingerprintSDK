...
class MacroFocusTriggerOnFinger(
    provider: CameraContextProvider
) : FocusManager(provider) {

    companion object {
        private val TAG = MacroFocusTriggerOnFinger::class.simpleName
    ...
    override fun setOptimalMode() {
        ...
        if (afModes?.contains(CaptureRequest.CONTROL_AF_MODE_MACRO) == true) {
            Log.d(TAG, "FOCUS -- Focus Mode Set To: MACRO")
            ...
            Log.d(TAG, "FOCUS -- No Macro Mode available, Focus Mode Set To: AUTO")
            requestBuilder.set(CaptureRequest.CONTROL_AF_MODE, CaptureRequest.CONTROL_AF_MODE_AUTO)
        } else {
            Log.d(TAG, "FOCUS -- No Macro Mode available, Focus Mode Set To: OFF")
